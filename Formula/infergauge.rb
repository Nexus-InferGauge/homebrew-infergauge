...
class Infergauge < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Nexus-InferGauge/infergauge-releases/releases/download/v0.7.5/infergauge-v0.7.5-macos-arm64.tar.gz"
      sha256 "b7b5606da36d68eeff7a90185a554ef316ab7ae646820f244300b362b9553d7b"
    end
    on_intel do
  ...
  on_linux do
    url "https://github.com/Nexus-InferGauge/infergauge-releases/releases/download/v0.7.5/infergauge-v0.7.5-linux-x86_64.tar.gz"
    sha256 "4644dfe1651ba554798888bcd2f3ceca97d1ad745d4b99649c04e1d1fa7991cb"
  end
